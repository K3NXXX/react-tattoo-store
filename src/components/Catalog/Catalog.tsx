        ...
        <section id="toCatalog" className={style.catalog}>
            <div className={style.catalog__top}>
                ...
                <div className={style.catalog__list}>
                    {catalogList.map((catalogItem, index) => (<Link key={index} className={style.link} to={`/react-tattoo-store/catalog/${index}`}>
                ...
                <div className={style.catalog__listTablet}>
                    ...
                    {catalogListTablet.map((catalogItem, index) => (<Link key={index} className={style.link} to={`/react-tattoo-store/catalog/${index}`}>
                            <img src={catalogItem.image}/>
                            <p className={style.image__text}>{catalogItem.description}</p>
                        </Link>))}
                    </div>
                ...
                <div className={style.catalog__listPhone}>
                    ...
                    {catalogListPhone.map((catalogItem, index) => (<Link key={index} className={style.link} to={`/react-tattoo-store/catalog/${index}`}>
                            <img src={catalogItem.image}/>
                            <p className={style.image__text}>{catalogItem.description}</p>
                        </Link>))}
                    </div>
            ...
            <div className={style.catalog__bottom}>
                <div className={style.left}>
                    ...
                    <Link to="/react-tattoo-store/catalog/4">Дивитися в каталозі </Link>
                </div>
                <div className={style.right}>
                    <img src={catalog13} alt="catalogImg"/>
                    <p>Foxx kitsune - хіт 2023 року</p>
                    <Link to="/react-tattoo-store/catalog/2">Дивитися в каталозі </Link>
                </div>
            </div>
